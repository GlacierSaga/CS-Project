...
class GameBoard:
    def __init__(self, board_size=19):
        ...
        # term label that appears on the bottom right
        self.colour_label = Label(main_screen, text=f"{self.colour.capitalize()}'s term", padx=8, pady=7)
        self.colour_label.pack(side=RIGHT)
